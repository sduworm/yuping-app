...
import com.yuping.chat.app.login.model.LoginResult;
...
import com.yuping.chat.BuildConfig;
...
public class AppService implements AppServiceProvider {
     ...
     * <br>
     */
    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释，http 前缀不能省略*/ = "http://192.168.0.20:8888";
